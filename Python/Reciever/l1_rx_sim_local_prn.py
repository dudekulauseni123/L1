...
rx_iq_arr = []
#rx_iq_arr=l1.bin2csv("fcl1_fs4M.sc16q11", "rxwave.csv",chunk_bytes=4096)
#rx_iq_arr=l1.bin2csv("rx_samples_fcl1_fs4M_wireless.sc16q11", "rxwave.csv",chunk_bytes=4096)
#rx_iq_arr=l1.bin2csv("rx_samples_fcl1_fs4M_wireless_gain10.sc16q11", "rxwave.csv",chunk_bytes=4096)
rx_iq_arr=l1.bin2csv("rx_samples_fcl1_fs4M_wireless_gain10_fb10M.sc16q11", "rxwave.csv",chunk_bytes=4096)

satVis = 0
for istep in range(numSteps):
    
    waveform = rx_iq_arr[istep*samplePerStep:(istep+1)*samplePerStep] 
...
for i in range(satVis):
    ...
    ber = ((len(navic_raw_data))-(sum(np.equal(navbits,bits))))
