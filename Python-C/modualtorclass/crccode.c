...
int main() {
    // Example usage of the CRC-24Q function
    uint8_t data[] =  {0x01, 0x23, 0x45, 0x67};
    int dataLengthBits = sizeof(data) * 8;

    uint32_t crcResult = rtk_crc24q(data, dataLengthBits);

    // Print the CRC-24Q result
    printf("CRC-24Q Result: %06X\n", crcResult);
