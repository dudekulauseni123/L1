...
def navic_pcps_acquisition(x, prnSeq_pilot, fs, fSearch, relative_peak=True,threshold=5):
   ...
   # ts = 1/fs
    ...
    if(relative_peak):
        ...
        print("Max abs Rxd  =", np.abs(Rxd[maxRow,maxCol]))
        thresholdEst = Rxd[maxRow,maxCol]/peak2
        thresholdEst = np.abs(thresholdEst)
    ...
    print("Threshold est:",thresholdEst)
...
class NavicTracker:
    ...
    def stepImpl(self, u):
       ...
       #The below line is added to fix the bug related to receiveing correct data with one bit delay
        ...
        return y_pilot, y_data, fqyerr, fqynco, pherr, phnco, delayerr, delaynco, cn0_cap, pli, int(self.lock_fail_counter),fc,coarsedelay, finedelay
